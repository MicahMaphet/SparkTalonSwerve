...
public class SwerveModule extends SubsystemBase {
    ...
    public SwerveModule(String moduleName, int driveMotorID, int steerMotorID, boolean driveInverted, boolean steerInverted, int encoderID, double encoderOffset) {
        ...
        driveMotorConfiguration.Slot0 = new Slot0Configs()
            .withKP(12.0)
            .withKI(0.0)
            .withKD(0.01);
        ...
        steerMotorConfig.absoluteEncoder
            .inverted(true);
    ...
    public void setState(SwerveModuleState state) {
        ...
        steerMotor.getClosedLoopController().setReference(desiredAngle.getRotations(), ControlType.kPosition, ClosedLoopSlot.kSlot0);
    }
    ...
    public Rotation2d getAngle() {
        return Rotation2d.fromRotations(encoder.getAbsolutePosition().getValueAsDouble() + encoderOffset);
    }
    ...
    public SwerveModulePosition getPosition() {
        ...
        return new SwerveModulePosition(
            // the relative encoder on the talonfx drive motor divided by the number of rotations needed to spin the drive wheel once
            ...
            (driveMotor.getPosition().getValueAsDouble() / Constants.DriveGearRatio) * Math.PI * Constants.WheelDiameter, 
            getAngle()
        );
    }
